...
package com.squaredcandy.lunar_common.accompanist
 ...
 *
 * A copy of the Accompanist's SystemUiController v0.21.2 but with scrim support
 *
 * @sample com.google.accompanist.sample.systemuicontroller.SystemUiControllerSample
 */
@Stable
interface LunarSystemUiController {
    ...
    /**
     * Set the navigation scrim color. Requires version API 28 or higher
     */
    @RequiresApi(Build.VERSION_CODES.P)
    fun setNavigationScrimColor(
        color: Color,
    )
...
/**
 * Remembers a [LunarSystemUiController] for the current device.
 */
@Composable
fun rememberLunarSystemUiController(): LunarSystemUiController {
    val view = LocalView.current
    return remember(view) { AndroidLunarSystemUiController(view) }
}
 ...
 *
 * Typically you would use [rememberLunarSystemUiController] to remember an instance of this.
 */
internal class AndroidLunarSystemUiController(
    private val view: View
) : LunarSystemUiController {
    ...
    @RequiresApi(Build.VERSION_CODES.P)
    override fun setNavigationScrimColor(color: Color) {
