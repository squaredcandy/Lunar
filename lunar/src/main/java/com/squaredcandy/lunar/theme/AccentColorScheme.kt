...
internal object AccentedColorScheme {
    val accentedLightColorScheme = AccentColorScheme(
        red = ColorFamily(
            redLight,
            onRedLight,
            redContainerLight,
    ...
    val accentedDarkColorScheme = AccentColorScheme(
        red = ColorFamily(
            redDark,
            onRedDark,
            redContainerDark,
    ...
    val accentedLightMediumContrastColorScheme = AccentColorScheme(
        red = ColorFamily(
    ...
    val accentedLightHighContrastColorScheme = AccentColorScheme(
        red = ColorFamily(
    ...
    val accentedDarkMediumContrastColorScheme = AccentColorScheme(
        red = ColorFamily(
    ...
    val accentedDarkHighContrastColorScheme = AccentColorScheme(
        red = ColorFamily(
            redDarkHighContrast,
